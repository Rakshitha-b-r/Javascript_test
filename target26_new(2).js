...
`;
    ...
    generatedHTML += `<th class='table-header' rowspan='1' colspan='9' style='height: 40px;'><b>Applicable limit</b></th>`;
    generatedHTML += "</tr>";
    ...
    for (column_type of ["dimension_like", "measure_like", "table_calculations"]) {
      ...
      for (field of queryResponse.fields[column_type]) {
        ...
        generatedHTML += `<th class='table-header' style='text-align: left; padding: 5px;width:300px'>${header[i]}</th>`;
