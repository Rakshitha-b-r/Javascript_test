looker.plugins.visualizations.add({
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    `;
      ...
      generatedHTML += `<th class='table-header' style="height:100px; width:60px;">Name</th>`;
      generatedHTML += `<th class='table-header' style="height:100px; width:80px;">National Code</th>`;
      generatedHTML += `<th class='table-header' style="height:100px; width:80px;">Residence of the Counterparty</th>`;
