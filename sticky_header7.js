looker.plugins.visualizations.add({
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    generatedHTML += `<th class='table-header' rowspan='3' colspan='3'><b>Exposure value before application of exemptions and CRM </b><hr></th>`;
    ...
    generatedHTML += `<th class='table-header' rowspan='3' colspan='3'><b>Exposure value after application of exemptions and CRM</b><hr></th>`;
    generatedHTML += "</tr>";
    generatedHTML += "<tr class='table-header'>";
    ...
    generatedHTML += `<th class='table-header' colspan='6' style="height:25px;">Direct exposures<hr></th>`;
