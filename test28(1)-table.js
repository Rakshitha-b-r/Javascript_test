looker.plugins.visualizations.add({
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    generatedHTML += `<th class='table-header' rowspan='6'>Direct exposures</th>`;
    generatedHTML += `<th class='table-header' rowspan='6'>Indirect exposures</th>`;
    generatedHTML += `<th class='table-header' colspan='3'>Additional exposures arising from transactions where there is an exposure to underlying assets</th>`;
    generatedHTML += "</tr>";
    generatedHTML += "<tr>";
