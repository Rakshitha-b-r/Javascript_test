looker.plugins.visualizations.add({
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    generatedHTML += `<th class='table-header' colspan='3'><b>COUNTERPARTY</b><hr style="margin: 0;width: 50.7%;height: 0.6px;top: 27px;position: absolute;left: 0;background-color: black;"></th>`;
    ...
    generatedHTML += `<th class='table-header' rowspan='3' colspan='3'><b>Exposure value before application of exemptions and CRM </b><hr style="margin: 0;position: absolute;width: 25.15%;top: 83px;left: 1632px;background-color: black;height: 0.6px;"></th>`;
    generatedHTML += `<th class='table-header' colspan='8'><b>ELIGIBLE CREDIT RISK MITIGATION (CRM) TECHNIQUES</b><hr style="height: 0.6px;top: 27px;position: absolute;left: 1885px;width: 22.71%;margin: 0;background-color: black;"></th>`;
    generatedHTML += `<th class='table-header' rowspan='5'>(-) Amounts exempted</th>`;
    generatedHTML += `<th class='table-header' rowspan='3' colspan='3'><b>Exposure value after application of exemptions and CRM</b><hr style="margin: 0;height: 0.6px;top: 83px;position: absolute;width: 8.78%;left: 2615.5px;background-color: black;"></th>`;
    generatedHTML += "</tr>";
    generatedHTML += "<tr class='table-header'>";
    ...
    generatedHTML += `<th class='table-header' colspan='14' style="height:25px;"><hr style="margin: 0;position: absolute;height: 0.6px;top: 55px;width: 37.89%;background-color: #262d33;left: 369px;"></th>`;
    ...
    generatedHTML += `<th class='table-header' colspan='6' style="height:25px;">Direct exposures<hr style="margin: 0;position: absolute;height: 0.6px;top: 82.5px;width: 35.45%;left: 369px;background-color: black;"></th>`;
